...
const translations = {
    ...
    //   "info-text":  "Компания Iluxsiir OÜ основана в 2023 году и занимается оптовой и розничной торговлей профессиональными средствами для ухода за волосами и ногтями. На рынке Эстонии мы представлены через услуги интернет-магазина https://shopforhair.ee/ee/. Также в октябре 2024 года в Таллине открылся наш первый розничный магазин —  в торговом центре Мустакиви (Mahtra tn 1, 13811 Tallinn, Mustakivi keskus). Несмотря на молодость компании, её руководящий менеджмент обладает десятилетиями опыта работы на бьюти-рынке. Мы активно следим за тенденциями в индустрии красоты и регулярно обновляем ассортимент товаров, своевременно предлагая своим клиентам новинки рынка и связанные с ними специальные акции. Ассортимент Iluxsiir включает в себя более чем 3500 товаров от ведущих мировых и европейских брендов. Мы сотрудничаем с такими производителями, как Black Professional (Италия), FUDGE (Великобритания), Kallos (ЕС), Stapiz (ЕС), LUSSONI (ЕС), NIAMH (Италия), Dikson (Италия), Feetcalm (Испания), Beauty Image (Испания), Andis (США) и многими другими. Наша миссия — обеспечить профессионалов ухода за волосами и ногтями качественной продукцией по конкурентным ценам. А также оказать всестороннюю помощь обычным покупателям — в виде профессиональных консультаций по любому из товаров.Наши приоритеты – удобная и быстрая доставка в течение 1-3 суток. Компания Iluxsiir OÜ нацелена на решение вопросов своих клиентов. В предложении компании предусмотрены отдельные программы для обычных, профессиональных и корпоративных клиентов — у нас есть что предложить каждому, с учётом его персональных интересов.Теперь вы знаете о нас больше. Компания Iluxsiir OÜ благодарит вас за то, что вы ознакомились с этой информацией. До скорой встречи!",
      "info-paragraph-1": "Компания Iluxsiir OÜ основана в 2023 году и занимается оптовой и розничной торговлей профессиональными средствами для ухода за волосами и ногтями. На рынке Эстонии мы представлены через услуги интернет-магазина https://shopforhair.ee/ee/. Также в октябре 2024 года в Таллине открылся наш первый розничный магазин — в торговом центре 'Мустакиви' (Mahtra tn 1, 13811 Tallinn, Mustakivi keskus).",
    ...
    //   "info-title":`Ettevõtte kohta Ilu<span class="colored">X</span>siir`,
      ...
      "shop-telephone":`poe telefon: <a href="tel:+37255940771">+372 55-940-771</a>`,
      "office-email": `mail: <a href="mailto:office@iluxsiir.ee">office@iluxsiir.ee</a>`,
      "working-time": "E-R: 10.00 - 20.00 <br> Sat-Wk: 10.00 - 18.00",
      "find-inside":`a href="https://mustakivikeskus.ee/plaan/?location=store3030" target="_blank"`,
    ...
    //   "form-title":"Kontakt ILUXSIIR",
      ...
      "users-agreement": `"Nõustun tingimustega <a href="./../../files/agreement-Iluxsiir_ru.pdf" target="_blank"> privaatsuspoliitika </a>        ja annan nõusoleku oma isikuandmete töötlemiseks."`,
      "submit-btn": "Saada",
      // footer
    ...
    //   "info-title": `About the company Ilu<span class="colored">X</span>siir`,
      ...
      "office-email": `mail: <a href="mailto:office@iluxsiir.ee">office@iluxsiir.ee</a>`,
      "working-time": "Mon-Fr: 10.00 - 20.00 <br> Sat-Sun: 10.00 - 18.00",
      "find-inside":`a href="https://mustakivikeskus.ee/plaan/?location=store3030" target="_blank"`,
      // benefits
    ...
    //   "form-title":"Contact ILUXSIIR",
      ...
      "users-agreement": `"I accept the terms and conditions <a href="./../../files/agreement-Iluxsiir_en.pdf" target="_blank">privacy policy  </a>company and I give consent to the processing of my personal data."`,
      "submit-btn": "Send",
      // footer
